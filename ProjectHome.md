Nilestore is a secure and fault tolerant distributed storage system built using [Kompics](http://kompics.sics.se/) component model framework following the design of [Tahoe-LAFS](http://tahoe-lafs.org/).
