...
/**
 * The Class SegmentFetcher.
 * 
 * @author Mahmoud Ismail <mahmoudahmedismail@gmail.com>
 */
public class SegmentFetcher extends PortType {
	{
		negative(AddShares.class);
		negative(NoMoreShares.class);
		positive(WantMoreShares.class);
		negative(GetSegment.class);
		positive(GetSegmentResponse.class);
	}
}
