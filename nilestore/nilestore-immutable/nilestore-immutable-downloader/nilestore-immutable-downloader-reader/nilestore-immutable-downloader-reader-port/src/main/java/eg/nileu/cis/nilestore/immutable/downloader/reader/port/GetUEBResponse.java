...
/**
 * The Class GetUEBResponse.
 * 
 * @author Mahmoud Ismail <mahmoudahmedismail@gmail.com>
 */
public class GetUEBResponse extends ReqCompleted {

	/** The UEB. */
	private final byte[] UEB;

	/**
	 * Instantiates a new gets the ueb response.
	 * 
	 * @param sharenum
	 *            the sharenum
	 * @param status
	 ...
	 *            the ueb
	 */
	public GetUEBResponse(int sharenum, Status status, byte[] ueb) {
