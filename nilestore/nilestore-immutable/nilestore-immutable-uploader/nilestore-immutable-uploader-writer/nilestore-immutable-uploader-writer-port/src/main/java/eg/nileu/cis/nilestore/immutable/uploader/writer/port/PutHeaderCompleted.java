...
/**
 * The Class PutHeaderCompleted.
 * 
 * @author Mahmoud Ismail <mahmoudahmedismail@gmail.com>
 */
public class PutHeaderCompleted extends ReqCompleted {

	/**
	 * Instantiates a new put header completed.
	 * 
	 * @param sharenum
	 *            the sharenum
	 * @param status
	 *            the status
	 */
	public PutHeaderCompleted(int sharenum, Status status) {
