...
/**
 * The Class CloseCompleted.
 * 
 * @author Mahmoud Ismail <mahmoudahmedismail@gmail.com>
 */
public class CloseCompleted extends ReqCompleted {

	/**
	 * Instantiates a new close completed.
	 * 
	 * @param sharenum
	 *            the sharenum
	 * @param status
	 *            the status
	 */
	public CloseCompleted(int sharenum, Status status) {
