...
/**
 * The Class PutUEBCompleted.
 * 
 * @author Mahmoud Ismail <mahmoudahmedismail@gmail.com>
 */
public class PutUEBCompleted extends ReqCompleted {

	/**
	 * Instantiates a new put ueb completed.
	 * 
	 * @param sharenum
	 *            the sharenum
	 * @param status
	 *            the status
	 */
	public PutUEBCompleted(int sharenum, Status status) {
