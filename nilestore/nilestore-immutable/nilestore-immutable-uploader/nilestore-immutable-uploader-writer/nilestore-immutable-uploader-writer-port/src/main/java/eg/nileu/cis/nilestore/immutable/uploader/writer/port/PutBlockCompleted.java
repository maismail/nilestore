...
/**
 * The Class PutBlockCompleted.
 * 
 * @author Mahmoud Ismail <mahmoudahmedismail@gmail.com>
 */
public class PutBlockCompleted extends ReqCompleted {

	/**
	 * Instantiates a new put block completed.
	 * 
	 * @param sharenum
	 *            the sharenum
	 * @param status
	 *            the status
	 */
	public PutBlockCompleted(int sharenum, Status status) {
