 ...
 */
public class Download extends TaggedRequest {

	/** The uri cap. */
	private final CHKFileURI uriCap;
	 ...
	 *            the requestagent
	 */
	public Download(CHKFileURI uriCap, Agent requestagent) {
		super(requestagent);
		this.uriCap = uriCap;
	}
