...
import eg.nileu.cis.nilestore.availablepeers.port.NsAvailablePeersInit;
...
/**
 * The Class NsCentralizedAvailablePeersInit.
 * 
 * @author Mahmoud Ismail <mahmoudahmedismail@gmail.com>
 */
public class NsCentralizedAvailablePeersInit extends NsAvailablePeersInit {

	/** The introducer configuration. */
	private final IntroducerConfiguration introducerConfiguration;

	/**
	 * Instantiates a new ns centralized available peers init.
	 * 
	 * @param self
	 *            the self
	 ...
	 *            the introducer configuration
	 */
	public NsCentralizedAvailablePeersInit(NilestoreAddress self,
			boolean isStorageServer,
			IntroducerConfiguration introducerConfiguration) {
		super(self, isStorageServer);
