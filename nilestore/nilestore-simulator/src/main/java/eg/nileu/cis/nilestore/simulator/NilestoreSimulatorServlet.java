...
/**
 * The Class NilestoreSimulatorServlet.
 * 
 * @author Mahmoud Ismail <mahmoudahmedismail@gmail.com>
 */
@SuppressWarnings("serial")
public class NilestoreSimulatorServlet extends AbstractServlet {

	/**
	 * Instantiates a new nilestore simulator servlet.
	 * 
	 * @param servletId
	 *            the servlet id
	 */
	public NilestoreSimulatorServlet(String servletId) {
		super(servletId);
	}
