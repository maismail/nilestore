...
/**
 * The Class WebRequestDestinationFilter.
 * 
 * @author Mahmoud Ismail <mahmoudahmedismail@gmail.com>
 */
public final class WebRequestDestinationFilter extends
		ChannelFilter<WebRequest, Integer> {

	/**
	 * Instantiates a new web request destination filter.
	 * 
	 * @param dest
	 *            the dest
	 */
	public WebRequestDestinationFilter(int dest) {
		super(WebRequest.class, dest, false);
	}
