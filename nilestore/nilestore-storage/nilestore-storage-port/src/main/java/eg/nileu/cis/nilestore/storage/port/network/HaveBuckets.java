...
/**
 * The Class HaveBuckets.
 * 
 * @author Mahmoud Ismail <mahmoudahmedismail@gmail.com>
 */
public class HaveBuckets extends ExtMessage {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 4356174019590353173L;

	/** The storage index. */
	private final String storageIndex;

	/**
	 * Instantiates a new have buckets.
	 * 
	 * @param source
	 *            the source
	 * @param destination
	 ...
	 *            the storage index
	 */
	public HaveBuckets(ComponentAddress source, ComponentAddress destination,
			String storageIndex) {
