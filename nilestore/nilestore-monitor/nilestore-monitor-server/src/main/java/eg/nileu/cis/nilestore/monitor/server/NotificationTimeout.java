...
/**
 * The Class NotificationTimeout.
 * 
 * @author Mahmoud Ismail <mahmoudahmedismail@gmail.com>
 */
public class NotificationTimeout extends Timeout {

	/** The overlay address. */
	private final NilestoreAddress overlayAddress;

	/**
	 * Instantiates a new notification timeout.
	 * 
	 * @param request
	 *            the request
	 * @param address
	 *            the address
	 */
	public NotificationTimeout(ScheduleTimeout request, NilestoreAddress address) {
		super(request);
