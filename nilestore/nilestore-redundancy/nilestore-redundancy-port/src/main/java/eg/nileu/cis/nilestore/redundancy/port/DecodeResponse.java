...
/**
 * The Class DecodeResponse.
 * 
 * @author Mahmoud Ismail <mahmoudahmedismail@gmail.com>
 */
public class DecodeResponse extends Response {

	/** The output buffers. */
	private final ByteArray[] outputBuffers;

	/**
	 * Instantiates a new decode response.
	 * 
	 * @param request
	 *            the request
	 * @param outputBuffers
	 *            the output buffers
	 */
	public DecodeResponse(Decode request, ByteArray[] outputBuffers) {
		super(request);
